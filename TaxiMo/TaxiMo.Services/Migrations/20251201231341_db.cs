        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLat = table.Column<decimal>(type: "decimal(10,8)", nullable: true),
                    CurrentLng = table.Column<decimal>(type: "decimal(11,8)", nullable: true),
                    LastLocationUpdate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverAvailabilities", x => x.AvailabilityId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RecipientDriverId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DriverNotifications_Drivers_RecipientDriverId",
                        column: x => x.RecipientDriverId,
                        principalTable: "Drivers",
                        principalColumn: "DriverId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DriverRoleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DriverId = table.Column<int>(type: "int", nullable: false),
                    RoleId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverRoles", x => x.DriverRoleId);
                    table.ForeignKey(
                        name: "FK_DriverRoles_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "DriverId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DriverRoles_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    FareEstimate = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    FareFinal = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rides_Locations_DropoffLocationId",
                        column: x => x.DropoffLocationId,
                        principalTable: "Locations",
                        principalColumn: "LocationId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rides_Locations_PickupLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PromoUsages_PromoCodes_PromoId",
                        column: x => x.PromoId,
                        principalTable: "PromoCodes",
                        principalColumn: "PromoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromoUsages_Rides_RideId",
                        column: x => x.RideId,
                        principalTable: "Rides",
                        principalColumn: "RideId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriverNotifications_RecipientDriverId",
                table: "DriverNotifications",
                column: "RecipientDriverId");

            migrationBuilder.CreateIndex(
                name: "IX_DriverRoles_DriverId",
                table: "DriverRoles",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_DriverRoles_RoleId",
                table: "DriverRoles",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromoUsages_RideId",
                table: "PromoUsages",
                column: "RideId");

            migrationBuilder.CreateIndex(
                name: "IX_PromoUsages_UserId",
                table: "PromoUsages",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rides_DropoffLocationId",
                table: "Rides",
                column: "DropoffLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Rides_PickupLocationId",
                table: "Rides",
